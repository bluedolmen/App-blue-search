<@markup id="css" >
   ...
   <@link href="${url.context}/res/BlueSearch-share-jar/css/bluesearch/proxy-home.css" group="search"/>
   <@link href="${url.context}/res/BlueSearch-share-jar/components/search/delib-search.css" group="search"/>
   <#if user.name == "public">
	   <@link href="${url.context}/res/BlueSearch-share-jar/components/search/delib-search-public.css" group="search"/>
   </#if>
</@>
   ...
   <@uniqueIdDiv>
      ...
      <div id="${el}-body" class="search">
         ...
         <div class="yui-gc form-row">
            ...
            <#-- search button -->
            <div class="yui-u align-right">
               <span id="${el}-search-button-2" class="yui-button-disable yui-push-button-disable search-icon-disable">
                  <span class="first-child">
                     <button type="button">${msg('button.search')}</button>
                  </span>
               </span>
